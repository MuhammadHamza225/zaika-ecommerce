...
const Store = () => {
  ...
  <button className='mt-5 px-4 py-2 border border-black text-[10px] font-semibold hover:text-white transition hover:bg-[#ff695c] cursor-pointer'>SHOP NOW</button>
</div>
